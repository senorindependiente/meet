...
const credentials = {
  ...
  redirect_uris: ["https://senorindependiente.github.io/meet/"],
  javascript_origins: [
...
//getAccessToken serverless function. This function will need the code from the first serverless function "getAuthURL" above to give out the token
module.exports.getAccessToken = (event) => {
  //code from previous serverless function will go in here
